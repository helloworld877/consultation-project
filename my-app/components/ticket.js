...
const Ticket = ({
  ...
  const [isCancelConfirmationVisible, setCancelConfirmationVisible] =
    useState(false);
  const [linesMenString, setLinesMenString] = useState("");
  const [actualSeatNumber, setActualSeatNumber] = useState("");
  useEffect(() => {
  ...
  return (
    <div className="card">
      ...
      <div className="ticket-details">
        ...
        <p>
          <strong>Seat Number:</strong> {actualSeatNumber}
        </p>
      </div>
