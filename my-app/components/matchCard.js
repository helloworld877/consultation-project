...
const MatchCard = () => {
    ...
    const matchPageDetailsUrl = `/match-details?homeTeam=${matchDetails.homeTeam}&awayTeam=${matchDetails.awayTeam}&venue=${matchDetails.venue}&dateTime=${matchDetails.dateTime}&mainReferee=${matchDetails.mainReferee}&linesmen=${encodeURIComponent(matchDetails.linesmen.join(', '))}`;
    
    return (
       
            <div className="card">
                 <Link href={matchPageDetailsUrl} className="match-link" >
